...
export default function Footer() {
  ...
  // Default social links for fallback
  const defaultSocials: SocialResponse['data'] = {
    facebook: "#",
    instagram: "#",
    twitter: "#",
    linkedin: "#",
  ...
  const socialsToShow = Object.keys(socialLinks).length > 0 ? socialLinks : defaultSocials;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-gray-400 max-w-xs">
              Your trusted partner for finding premium properties in Dominican Republic.
            </p>
            <div className="flex gap-4 mt-5">
              {Object.entries(socialsToShow).map(([platform, url], index: number) => {
                const Icon = socialIcons[platform.toLowerCase()] || Facebook;
                return (
                  <a 
                    key={platform} 
                    href={url || "#"} 
